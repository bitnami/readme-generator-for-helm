...
/* Transform the list of Parameters and section descriptions into an object whose keys are the section names and
*  their values are an object with array of parameters and description lines for the section
*  Example:
*  {
*    "section1": {description: [...], parameters: [{...}, {...}]},
*    "section2": {description: [...], parameters: [{...}, {...}]}
*  }
*/
function buildSectionsObjects(parameters, sectionDescriptions) {
  parametersBySection = groupBy(parameters, 'section');

  const sectionsObjects = {};
  Object.entries(parametersBySection).forEach(([section, parameters]) => {
    const description = Object.keys(sectionDescriptions).includes(section) ? sectionDescriptions[section] : [];
    sectionsObjects[section] = {description, parameters};
  });
